...
class AuthController extends BaseController
{
    ...
    /**
     * Show the standalone registration view (without header and footer)
     */
    public function registrationPageStandalone()
    {
        return response()->view('auth.register-standalone');
    }
