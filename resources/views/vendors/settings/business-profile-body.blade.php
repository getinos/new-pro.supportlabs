...
$bp = $businessProfile ?? [];
@endphp
@if(!empty($bp['profile_picture_url']))
    <img class="lw-business-profile-image" src="{{ $bp['profile_picture_url'] }}" alt="">
@else
...
<x-lw.input-field type="text" id="lwAddressField" data-form-group-class="" :label="__tr('Address')" value="{{ $bp['address'] ?? '' }}" name="address" />
<x-lw.input-field type="text" id="lwDescriptionField" data-form-group-class="" :label="__tr('Description')" value="{{ $bp['description'] ?? '' }}" name="description" />
<x-lw.input-field type="selectize" data-lw-plugin="lwSelectize" id="lwVerticalField"
    data-form-group-class="" data-selected="{{ $bp['vertical'] ?? '' }}" :label="__tr('Industry type')" name="vertical">
...
<x-lw.input-field type="text" id="lwAboutField" data-form-group-class="" :label="__tr('About')" value="{{ $bp['about'] ?? '' }}" name="about" />
<x-lw.input-field type="email" id="lwEmailField" data-form-group-class="" :label="__tr('Email')" value="{{ $bp['email'] ?? '' }}" name="email" />
<x-lw.input-field type="url" id="lwUrl1Field" data-form-group-class="" :label="__tr('Website 1')" value="{{ $bp['websites'][0] ?? '' }}" name="websites[0]" />
<x-lw.input-field type="url" id="lwUrl2Field" data-form-group-class="" :label="__tr('Website 2')" value="{{ $bp['websites'][1] ?? '' }}" name="websites[1]" />