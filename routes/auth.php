...
Route::group([
    ...
    // Standalone registration form (without header and footer) - accessible even when logged in
    Route::get('/register/vendor/standalone', [
        AuthController::class,
        'registrationPageStandalone',
    ])->name('auth.register.standalone');
